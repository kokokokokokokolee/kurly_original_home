...
export default function Sub5SignUpComponent ({회원가입, isConfirmModal, sendConfirmOpen, AddressSearchModalOepn, 주소1, 주소2}) {
    ...
    const onClickIdBtn=(e)=>{
        ...
        if(regExp.test(아이디)===false){
            ...
            axios({
                url:'https://qwefg.com/kurly_home/select_id_check.php',
                method:'POST',
                data:formData
            })
            .then((res)=>{
    ...
    const onClickEmailBtn = (e) => {
        ...
        if(이메일 ===''){
            ...
            axios({
                url:'https://qwefg.com/kurly_home/select_email_check.php',
                method:'POST',
                data:formData
            })
            .then((res)=>{
...
const onClickChooChunId=(e)=>{
    ...
    axios({
        url:'https://qwefg.com/kurly_home/select_ChooChun_Id.php',
        method:'POST',
        data : formData
    })
    .then((res)=>{
...
const onSubmitSignUp=(e)=>{
    ...
    if(아이디 === ""){
        ...
        axios({
            url: 'https://qwefg.com/kurly_home/signUp.php',
            method:'POST',
            data: formData
        })
        .then((res)=>{
